...
const MaleDelusionFAQ: React.FC = () => {
  const faqs = [
    {
      question: 'What is a "male delusion" in the context of relationships?',
      answer: 'In relationship psychology, "male delusion" refers to unrealistic expectations men might hold about dating, partnerships, or their own attractiveness in the dating market. These can include overestimating one\'s own desirability while simultaneously setting unrealistically high standards for potential partners, expecting traditional benefits without traditional contributions, or misunderstanding statistical realities of the dating landscape. This calculator addresses these potential misalignments by highlighting areas where expectations may not match reality.'
    },
    {
      question: 'How is the delusion score calculated?',
      answer: 'The delusion score is calculated based on your responses to various questions about dating expectations, standards, and self-awareness. The algorithm considers factors like the gap between your standards for others versus personal effort, age preferences, appearance priorities, income expectations, and other relationship beliefs. Some factors are weighted more heavily than others based on psychological research about relationship success predictors. The scoring system is designed to identify potential misalignments between expectations and reality, not to make judgments about an individual\'s worth or value.'
    },
    {
      question: 'Is this calculator only for men?',
      answer: 'While the calculator\'s name references "male delusion," anyone can use it for self-reflection regardless of gender. The questions address universal relationship dynamics and expectation management issues. The psychological principles of reciprocity, realistic expectations, and self-awareness apply to everyone in the dating landscape. Women, men, and non-binary individuals can all benefit from examining whether their relationship expectations align with reality and what they themselves bring to potential partnerships.'
    },
    {
      question: 'Does a high score mean I can\'t find a relationship?',
      answer: 'Not at all. A high delusion score doesn\'t mean you can\'t find a relationship—it simply suggests there may be a significant gap between your current expectations and realistic outcomes. This awareness is actually the first step toward improvement. By identifying specific areas where your expectations might be misaligned with reality, you can make targeted adjustments that could substantially improve your relationship prospects. Many people with initially high scores have successfully formed fulfilling relationships after recalibrating their approach to dating and partnerships.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes, considerable research supports this connection. Studies published in the Journal of Social and Personal Relationships found that individuals with unrealistic relationship expectations reported significantly lower relationship satisfaction and higher rates of relationship failure. Unrealistic expectations create a perpetual gap between desires and reality, leading to chronic disappointment. They can also cause individuals to overlook compatible partners who don\'t meet arbitrary criteria, while pursuing matches with whom they have little chance of forming lasting connections. Psychologists consider expectation management one of the most important factors in relationship satisfaction.'
    },
    {
      question: 'Why do so many people have unrealistic dating expectations?',
      answer: 'Several factors contribute to unrealistic expectations: (1) Media representations of relationships that emphasize idealized romantic narratives, (2) Social media creating distorted impressions of others\' appearances and lifestyles, (3) Dating apps promoting an illusion of endless options, (4) Cultural messages that encourage seeking "perfect" matches rather than building compatible partnerships, (5) Cognitive biases like the fundamental attribution error that lead us to overvalue our own positive qualities while being critical of others, and (6) Lack of realistic feedback from social circles that increasingly avoid honest but uncomfortable conversations.'
    },
    {
...
export default MaleDelusionFAQ;
