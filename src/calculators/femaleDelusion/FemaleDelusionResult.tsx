...
interface FemaleDelusionResultProps {
  score: number;
  answers: Record<string, number>;
}

const FemaleDelusionResult: React.FC<FemaleDelusionResultProps> = ({ score, answers }) => {
  ...
  const getAreaFeedback = () => {
    ...
    const strengths = [
      ...
      { area: "Growth Mindset", value: answers.selfImprovement },
    ...
    const improvements = [
      { area: "Financial Expectations", value: answers.financialExpectations },
      { area: "Appearance Standards", value: answers.appearanceStandards },
      { area: "Career Status", value: answers.careerStatus },
...
export default FemaleDelusionResult;
