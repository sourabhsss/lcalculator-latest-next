...
const CombinationsForm: React.FC<{
  ...
  const validateInputs = () => {
    ...
    if (nValue > 1000) {
      setError('n is too large for accurate calculation (maximum is 1000)');
      return false;
    }
  ...
  return (
    <Card className="w-full shadow-sm">
      <CardHeader className="bg-primary/5">
        <CardTitle className="text-xl">Combinations Calculator</CardTitle>
      </CardHeader>
        ...
        <form onSubmit={handleCalculate}>
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-sm text-muted-foreground mt-1">
                The number of elements to select from the set
              </p>
            </div>
