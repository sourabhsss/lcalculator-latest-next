...
import MaleDelusion from '../calculators/MaleDelusion';
import FAQSection from '../components/FAQSection';
import CTASection from '../components/CTASection';
import { Brain, Heart, Users, BarChart2, LineChart, FileText } from 'lucide-react';
import Link from 'next/link';

const MaleDelusionCalculator = () => {
  // FAQ data
  const faqs = [
    {
      question: 'What does the Male Delusion Calculator measure?',
      answer: 'The Male Delusion Calculator measures potential misalignments between dating expectations and reality. It assesses various factors like your standards for potential partners compared to what you offer, expectations about appearance, income, age preferences, and relationship dynamics. The goal is to identify areas where unrealistic expectations might be hindering relationship success.'
    },
    {
    ...
    {
      question: 'Is this calculator only relevant for men?',
      answer: 'While the name references "male delusion," the principles of realistic expectations, reciprocity, and self-awareness apply to everyone in the dating landscape regardless of gender. Anyone interested in examining whether their relationship expectations align with reality can benefit from using this calculator.'
    },
    {
  ...
  return (
    <CalculatorLayout
      ...
      description="Assess how realistic your dating expectations are with our free Male Delusion Calculator. Gain insights into potential misalignments between expectations and reality."
    >
      {/* Calculator Section */}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-border">
              ...
              <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
                <li>Only about 3.5% of the U.S. adult population earns over $200,000 annually</li>
                <li>Approximately 8% of men are over 6 feet tall (183cm)</li>
                <li>Less than 5% of adults maintain the level of physical fitness often idealized in media</li>
                <li>Only about 34% of U.S. adults hold a bachelor's degree, and just 13% have graduate degrees</li>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-border">
              ...
              <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
                ...
                <li>Individuals who prioritize character qualities over status markers report 42% higher relationship satisfaction</li>
                <li>Emotional intelligence and communication skills correlate more strongly with relationship success than physical attractiveness</li>
                <li>Relationships with aligned expectations report 76% higher satisfaction rates than those with significant expectation gaps</li>
          ...
          <div className="bg-primary/5 p-6 rounded-lg">
            ...
            <ul className="list-disc pl-5 space-y-2 mb-4 text-muted-foreground">
              <li>Relationships where partners perceive fair contribution have a 78% higher chance of lasting long-term</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-border">
              ...
              <ul className="list-disc pl-5 space-y-1 text-muted-foreground mb-4">
                <li>Average users make judgment decisions in less than 7 seconds per profile</li>
                <li>Visual cues are prioritized over substantive compatibility factors</li>
                <li>64% of users report continuing to search for better matches even when meeting compatible partners</li>
              </ul>
              <p className="text-muted-foreground">
          ...
          <div className="p-6 bg-white rounded-lg border border-border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="p-3 bg-gray-50 rounded-md">
                <h4 className="font-medium text-primary mb-1">The "Soulmate" Narrative</h4>
                <p className="text-sm text-muted-foreground">
            ...
            <div className="flex justify-center">
              <Link href="/love-calculator" className="bg-white p-5 rounded-lg shadow-sm border border-border hover:border-primary transition-colors inline-block">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  Try our <span className="text-primary">Love Calculator</span> for another perspective on relationship compatibility.
                </p>
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-border">
              <h3 className="text-xl font-semibold mb-4 flex items-center gap-2">
                ...
                <span>Professional Insights on Relationship Expectations</span>
              </h3>
              
              <div className="space-y-6">
                <div className="p-5 bg-gray-50 rounded-md">
                  <h4 className="font-medium text-primary mb-2">Dr. John Gottman, Relationship Researcher</h4>
                  <p className="text-muted-foreground">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/love-calculator" className="block bg-white p-6 rounded-lg shadow-sm border border-border hover:border-primary transition-colors">
              ...
              <p className="text-muted-foreground">
                Explore relationship compatibility and connection potential with our fun Love Calculator. A lighthearted way to consider relationship dynamics.
              </p>
            ...
            <Link href="/flames-calculator" className="block bg-white p-6 rounded-lg shadow-sm border border-border hover:border-primary transition-colors">
              <h3 className="text-lg font-semibold mb-2">FLAMES Calculator</h3>
              <p className="text-muted-foreground">
                Use the classic FLAMES game to playfully determine your relationship potential with another person.
              </p>
              <p className="text-primary mt-2 text-sm font-medium">Try it now →</p>
            </Link>
          </div>
      ...
      <div className="mt-8 text-center">
        <p className="text-muted-foreground">
          ...
          <Link href="/female-delusion-calculator" className="text-primary hover:underline">Female Delusion Calculator</Link> or{' '}
